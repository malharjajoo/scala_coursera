...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      var del_val = $uD(delta$1.apply__O());
      if ((del_val < 0)) {
        return $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$()))
      } else {
        var a_val = $uD(a$2.apply__O());
        var b_val = $uD(b$2.apply__O());
        var array = [((((-b_val) + $uD($g.Math.sqrt(del_val))) / 2) * a_val), ((((-b_val) - $uD($g.Math.sqrt(del_val))) / 2) * a_val)];
...
$c_sjsr_RuntimeLong.prototype.$classData = $d_sjsr_RuntimeLong;
/** @constructor */
function $c_sr_AbstractFunction0$mcD$sp() {
  $c_sr_AbstractFunction0.call(this)
}
$c_sr_AbstractFunction0$mcD$sp.prototype = new $h_sr_AbstractFunction0();
$c_sr_AbstractFunction0$mcD$sp.prototype.constructor = $c_sr_AbstractFunction0$mcD$sp;
/** @constructor */
function $h_sr_AbstractFunction0$mcD$sp() {
  /*<skip>*/
}
$h_sr_AbstractFunction0$mcD$sp.prototype = $c_sr_AbstractFunction0$mcD$sp.prototype;
/** @constructor */
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.init___sci_Map = (function(ref_map$1) {
  this.ref$undmap$1$f = ref_map$1;
  return this
});
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(p) {
  var jsx$1 = p.$$und1$f;
  $m_Lcalculator_Signal$();
  var expr = new $c_Lcalculator_Calculator$$anonfun$computeValues$1$$anonfun$apply$1().init___Lcalculator_Calculator$$anonfun$computeValues$1__T2(this, p);
...
/** @constructor */
function $c_Lcalculator_Calculator$$anonfun$computeValues$1$$anonfun$apply$1() {
  $c_sr_AbstractFunction0$mcD$sp.call(this);
  this.$$outer$3 = null;
  this.p$1$f = null
}
$c_Lcalculator_Calculator$$anonfun$computeValues$1$$anonfun$apply$1.prototype = new $h_sr_AbstractFunction0$mcD$sp();
$c_Lcalculator_Calculator$$anonfun$computeValues$1$$anonfun$apply$1.prototype.constructor = $c_Lcalculator_Calculator$$anonfun$computeValues$1$$anonfun$apply$1;
/** @constructor */
function $h_Lcalculator_Calculator$$anonfun$computeValues$1$$anonfun$apply$1() {
  /*<skip>*/
}
$h_Lcalculator_Calculator$$anonfun$computeValues$1$$anonfun$apply$1.prototype = $c_Lcalculator_Calculator$$anonfun$computeValues$1$$anonfun$apply$1.prototype;
$c_Lcalculator_Calculator$$anonfun$computeValues$1$$anonfun$apply$1.prototype.apply$mcD$sp__D = (function() {
  return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr($as_Lcalculator_Signal(this.p$1$f.$$und2$f).apply__O()), $as_sci_Map(this.$$outer$3.ref$undmap$1$f.filter__F1__O(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(arg$outer) {
    return (function(x$2) {
      var x = $as_T2(x$2);
      return (!$m_sr_BoxesRunTime$().equals__O__O__Z(x.$$und1$f, arg$outer.p$1$f.$$und1$f))
    })
  })(this)))))
});
$c_Lcalculator_Calculator$$anonfun$computeValues$1$$anonfun$apply$1.prototype.init___Lcalculator_Calculator$$anonfun$computeValues$1__T2 = (function($$outer, p$1) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$3 = $$outer
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1$$anonfun$apply$1.prototype.apply__O = (function() {
  return this.apply$mcD$sp__D()
});
var $d_Lcalculator_Calculator$$anonfun$computeValues$1$$anonfun$apply$1 = new $TypeData().initClass({
  Lcalculator_Calculator$$anonfun$computeValues$1$$anonfun$apply$1: 0
}, false, "calculator.Calculator$$anonfun$computeValues$1$$anonfun$apply$1", {
  Lcalculator_Calculator$$anonfun$computeValues$1$$anonfun$apply$1: 1,
  sr_AbstractFunction0$mcD$sp: 1,
  sr_AbstractFunction0: 1,
  O: 1,
  F0: 1,
  s_Function0$mcD$sp: 1,
  s_Serializable: 1,
  Ljava_io_Serializable: 1
});
$c_Lcalculator_Calculator$$anonfun$computeValues$1$$anonfun$apply$1.prototype.$classData = $d_Lcalculator_Calculator$$anonfun$computeValues$1$$anonfun$apply$1;
/** @constructor */
